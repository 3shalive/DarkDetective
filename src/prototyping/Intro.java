...
public class Intro extends World {
	final int hoyMenuSlieds = 3, t1 = 4000, t2 = 15000, h1 = 400;// € не знаю как то нармальному назвать константы 1-€
																	// число слайдов, 2-€ врем€ 3-€ высота
	...
	public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException {
		...
		if (i2 < hoyMenuSlieds) {
			switch (i2) {
			case 0:
				g.drawString("Хћой отец при загадочных обсто€тельствах", 20, h1);
				break;// здесь необходимо ввести остальной текст
			case 1:
				g.drawString("Х—јЎј,ѕјЎ≈Ћ Ќј’ќ…", 50, h1);
				break;
		...
		g.drawString("x=" + x10 + " y=" + y10 + " " + d1 + " tic",
				x10 - 54 + (x10 >= 100 ? x10 > 457 ? -55 : 0 : x10 >= 10 ? 10 : 20 + (35)), y10 - 9 - 1);// координаты
																											// мышки XD
		...
		/**
		 * for(int trtr=0;trtr<8192;trtr++){ //этот код был создан чтоб добавить лагов
		 * ложите проверить Rectangle a = new Rectangle(64, 64, 128, 128); g.draw(a);
		 * }//
		 */
	...
	public void enter(GameContainer container, StateBasedGame game) throws SlickException {
		...
		music.stop();
		assertTrue("Damn! Music is still playing!", !music.playing());
	}
}
